  ...
  return (
    <article className="mt-10">
      ...
      <Paragraph smallMarginTop={true}>
        For the technical curious, this section will dive into the parser
        algorithm and walks through the 4 steps on how it works. (Note that the
        algorithm is designed to parse single-column resumes in English.)
      </Paragraph>
      ...
      <Paragraph>
        And that is everything about the parser algorithm.
      </Paragraph>
      <Paragraph>
